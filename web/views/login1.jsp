    ...
    <div class="tabs-content">
        ...
        <div id="login-tab-content">
            <form class="login-form" action="j_security_check" method="post">
                <input type="text" class="input" name="j_username" id="user_login" required="required"
                       placeholder="Username">
                <input type="password" class="input" name="j_password" id="user_pass_login" required="required"
